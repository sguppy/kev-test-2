        ...
        return (
          <>
            ...
            <div className="border-t-2 border-green-400/30 pt-2">
              ...
              <p className="ml-4">STATUS: [DEVELOPMENT] - A lightweight operating system designed to leave no digital footprint.</p>
            </div>
          </>
        );
      case 'CONTACT':
                  ...
                  {tabs.map((tab) => (
                    <li key={tab}>
                      <button
                        ...
                        className={`px-4 py-1 border-2 transition-all duration-200 ${
                          activeTab === tab
